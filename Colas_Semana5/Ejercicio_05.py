...
def colocar_primer_a_al_frente(cola):
    ...
    # Colocar el nombre seleccionado al frente
    if nombre_a is not None:
        ...
        print("Nombre colocado en la cima:", nombre_a)
...
colocar_primer_a_al_frente(cola)
...
colocar_primer_a_al_frente(cola_vacia)